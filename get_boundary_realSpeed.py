...
plt.subplot(122)
polynomial_fit(real_speed1, distance_max, degrees, colors, ranges_min=0, ranges_max=40)
polynomial_fit(real_speed1, distance_min, degrees, colors, 0, ranges_min=0, ranges_max=40)
